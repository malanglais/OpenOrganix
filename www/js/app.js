...
.controller('mainController', ['$http', 'huskyModel', function($http, huskyModel) {
  ...
  fData = JSON.stringify({ __EVENTTARGET: "m$pc$cbCategories", __EVENTARGUMENT: "",   __LASTFOCUS: "", __VIEWSTATE: vSt, __VIEWSTATEGENERATOR: "FEF83A11", m$txtLogin: "", m$txtPassword: "", m$pc$cbYear: "2015", m$pc$cbCategories: "11", m$pc$cbSemaine: "2015-10-26", m$pc$cbArenaFilter: "-1", m$hdnOnLoadMessage: "", m$hdnOnLoadMessageOptions: ""});
